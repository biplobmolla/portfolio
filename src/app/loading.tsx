...
export default function Loading() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center dark:bg-[#0a0a0a] light:bg-[#fafafa] dark:text-green-400 light:text-blue-600 font-mono overflow-hidden transition-colors duration-300">
